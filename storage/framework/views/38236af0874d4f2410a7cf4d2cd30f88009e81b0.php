            ...
            <div class="card my-4">
                ...
                <div class="card card-plain h-100">
                    ...
                    <div class="card-body p-3">
                        <form action="<?php echo e(route('driver.store')); ?>" method="POST" enctype="multipart/form-data">
                            <?php echo csrf_field(); ?>
                            <div class="row">
...
<?php echo $__env->make('dashboard.dashboard', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp\htdocs\UAJY_RENTAL\resources\views/DriverCRUD/create.blade.php ENDPATH**/ ?>