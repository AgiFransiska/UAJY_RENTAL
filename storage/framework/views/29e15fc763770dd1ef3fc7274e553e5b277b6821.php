                ...
                <div class="card-header p-0 position-relative mt-n4 mx-3 z-index-2">
                    <div class="bg-gradient-primary shadow-primary border-radius-lg pt-4 pb-3">
                        <h6 class="text-white mx-3 text-center">
                            <strong> DATA KENDARAAN UAJY RENTAL</strong> 
                        </h6>
                    </div>
                </div>

                <div class=" me-3 my-3 text-end">
                    <a class="btn bg-gradient-dark mb-0" href="<?php echo e(route('kendaraan.create')); ?>"><i class="material-icons text-sm">add</i>&nbsp;&nbsp;Add New User</a>
                </div>
                ...
                <div class="card-body px-0 pb-2">     
                    <table class="table table-bordered">
                        ...
                        <tr>
                            ...
                            <td class="text-center"><?php echo e($mobil->nama_mobil); ?></td>
                            <td class="text-center"><?php echo e($mobil->status_ketersediaan_mobil); ?></td>
                            <td class="text-center">
                                <form action="<?php echo e(route('kendaraan.destroy', $mobil->id)); ?>" method="POST">
                                    <a class="btn btn-info btn-sm" href="<?php echo e(route('kendaraan.show',$mobil->id)); ?>"><i class="material-icons" style="font-size: 20px">remove_red_eye</i></a>
                                    <a class="btn btn-primary btn-sm" href="<?php echo e(route('kendaraan.edit',$mobil->id)); ?>"><i class="material-icons" style="font-size: 20px">mode_edit</i></a>
...
<?php echo $__env->make('dashboard.dashboard', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp\htdocs\UAJY_RENTAL\resources\views/KendaraanCRUD/index.blade.php ENDPATH**/ ?>