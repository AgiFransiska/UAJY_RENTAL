                    ...
                    <div class="card-header p-0 position-relative mt-n4 mx-3 z-index-2">
                        <div class="bg-gradient-primary shadow-primary border-radius-lg pt-4 pb-3">
                            ...
                            <div class="me-3 my-3 text-end">
                                <a class="btn bg-gradient-dark mb-0" href="<?php echo e(route('transaksi.create')); ?>"><i class="material-icons text-sm">add</i>&nbsp;&nbsp;Add New User</a>
                            </div>
                            ...
                            <tr>
                                ...
                                <td class="text-center">
                                    <form action="<?php echo e(route('transaksi.destroy', $trn->id)); ?>" method="POST">
                                        <a class="btn btn-info btn-sm" href="<?php echo e(route('transaksi.show',$trn->id)); ?>"><i class="material-icons" style="font-size: 20px">remove_red_eye</i></a>
                                        <a class="btn btn-primary btn-sm" href="<?php echo e(route('transaksi.edit',$trn->id)); ?>"><i class="material-icons" style="font-size: 20px">mode_edit</i></a>
...
<?php echo $__env->make('dashboard.dashboard', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp\htdocs\UAJY_RENTAL\resources\views/TransaksiCRUD/index.blade.php ENDPATH**/ ?>