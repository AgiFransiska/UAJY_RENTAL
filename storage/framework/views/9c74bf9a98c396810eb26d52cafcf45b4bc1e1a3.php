        ...
        <div class="col-12">
            <div class="card my-4">
                ...
                <div class=" me-3 my-3 text-end">
                    <a class="btn bg-gradient-dark mb-0" href="<?php echo e(route('driver.create')); ?>"><i class="material-icons text-sm">add</i>&nbsp;&nbsp;Add New User</a>
                </div>
                ...
                <div class="card-body px-0 pb-2">     
                    <table class="table table-bordered">
                        ...
                        <tr>
                            ...
                            <td class="text-center"><?php echo e($drv->nama_driver); ?></td>
                            ...
                            <td class="text-center">
                                <form action="<?php echo e(route('driver.destroy', $drv->id)); ?>" method="POST">
                                    <a class="btn btn-info btn-sm" href="<?php echo e(route('driver.show',$drv->id)); ?>"><i class="material-icons" style="font-size: 20px">remove_red_eye</i></a>
                                    <a class="btn btn-primary btn-sm" href="<?php echo e(route('driver.edit',$drv->id)); ?>"><i class="material-icons" style="font-size: 20px">mode_edit</i></a>
...
<?php echo $__env->make('dashboard.dashboard', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp\htdocs\UAJY_RENTAL\resources\views/DriverCRUD/index.blade.php ENDPATH**/ ?>