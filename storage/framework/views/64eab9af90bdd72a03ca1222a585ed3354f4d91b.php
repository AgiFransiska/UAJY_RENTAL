            ...
            <div class="col-12">
                <div class="card my-4">
                    ...
                    <div class=" me-3 my-3 text-end">
                        <a class="btn bg-gradient-dark mb-0" href="<?php echo e(route('mitra.create')); ?>"><i class="material-icons text-sm">add</i>&nbsp;&nbsp;Add New User</a>
                    </div>
                            ...
                            <tr>
                                ...
                                <td class="text-center">
                                    <form action="<?php echo e(route('mitra.destroy', $mit->id)); ?>" method="POST">
                                        <a class="btn btn-info btn-sm" href="<?php echo e(route('mitra.show',$mit->id)); ?>"><i class="material-icons" style="font-size: 20px">remove_red_eye</i></a>
                                        <a class="btn btn-primary btn-sm" href="<?php echo e(route('mitra.edit',$mit->id)); ?>"><i class="material-icons" style="font-size: 20px">mode_edit</i></a>
...
<?php echo $__env->make('dashboard.dashboard', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp\htdocs\UAJY_RENTAL\resources\views/MitraCRUD/index.blade.php ENDPATH**/ ?>