        ...
        <div class="col-12">
            <div class="card my-4">
                ...
                <div class=" me-3 my-3 text-end">
                    <a class="btn bg-gradient-dark mb-0" href="{{ route('promo.create') }}"><i class="material-icons text-sm">add</i>&nbsp;&nbsp;Add New User</a>
                </div>
                        ...
                        <tr>
                            ...
                            <td class="text-center">
                                <form action="{{ route('promo.destroy', $pro->id) }}" method="POST">
                                    <a class="btn btn-info btn-sm" href="{{ route('promo.show',$pro->id) }}"><i class="material-icons" style="font-size: 20px">remove_red_eye</i></a>
                                    <a class="btn btn-primary btn-sm" href="{{ route('promo.edit',$pro->id) }}"><i class="material-icons" style="font-size: 20px">mode_edit</i></a>
