    ...
    <div class="card card-body mx-3 mx-md-4 mt-n6">
        <div class="row gx-4 mb-2">
            ...
            <div class="mb-3 col-md-6">
                ...
                <span class="ms-1 form-control">{{ $promo->id}}</span>
            </div>

           
            <div class="mb-3 col-md-6">
                <span class="ms-1">Kode Promo</span>
                <span class="ms-1 form-control">{{ $promo->kode_promo }}</span>
            </div>

            
            <div class="mb-3 col-md-6">
                <span class="ms-1">Jenis Promo</span>
                <span class="ms-1 form-control">{{ $promo->jenis_promo }}</span>
            </div>

            
            <div class="mb-3 col-md-6">
                <span class="ms-1">Diskon</span>
                <span class="ms-1 form-control">{{ $promo->diskon }}</span>
            </div>

            
            <div class="mb-3 col-md-6">
                <span class="ms-1">Keterangan</span>
                <span class="ms-1 form-control">{{ $promo->keterangan }}</span>
            </div>

           
            <div class="mb-3 col-md-6">
                <span class="ms-1">Status</span>
                <span class="ms-1 form-control">{{ $promo->status_promo }}</span> 
            </div>
