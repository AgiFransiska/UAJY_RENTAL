                    ...
                    <div class="card-header p-0 position-relative mt-n4 mx-3 z-index-2">
                        <div class="bg-gradient-primary shadow-primary border-radius-lg pt-4 pb-3">
                            ...
                            <div class="me-3 my-3 text-end">
                                <a class="btn bg-gradient-dark mb-0" href="{{ route('transaksi.create') }}"><i class="material-icons text-sm">add</i>&nbsp;&nbsp;Add New User</a>
                            </div>
...
{{--                                 @if (count($role))
                                ...
                                <td class="text-center">
                                    <form action="{{ route('transaksi.destroy', $trn->id) }}" method="POST">
                                        <a class="btn btn-info btn-sm" href="{{ route('transaksi.show',$trn->id) }}"><i class="material-icons" style="font-size: 20px">remove_red_eye</i></a>
                                        <a class="btn btn-primary btn-sm" href="{{ route('transaksi.edit',$trn->id) }}"><i class="material-icons" style="font-size: 20px">mode_edit</i></a>
