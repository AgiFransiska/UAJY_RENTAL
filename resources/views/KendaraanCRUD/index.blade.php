        ...
        <div class="col-12">
            <div class="card my-4">
                ...
                <div class=" me-3 my-3 text-end">
                    <a class="btn bg-gradient-dark mb-0" href="{{ route('kendaraan.create') }}"><i class="material-icons text-sm">add</i>&nbsp;&nbsp;Add New User</a>
                </div>
                ...
                <div class="card-body px-0 pb-2">     
                    <table class="table table-bordered">
                        ...
                        <tr>
                            ...
                            <td class="text-center">{{ $mobil->status_ketersediaan_mobil }}</td>
                            <td class="text-center">
                                <form action="{{ route('kendaraan.destroy', $mobil->id) }}" method="POST">
                                    <a class="btn btn-info btn-sm" href="{{ route('kendaraan.show',$mobil->id) }}"><i class="material-icons" style="font-size: 20px">remove_red_eye</i></a>
                                    <a class="btn btn-primary btn-sm" href="{{ route('kendaraan.edit',$mobil->id) }}"><i class="material-icons" style="font-size: 20px">mode_edit</i></a>
